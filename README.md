...
A free-to-play, unofficial fan-made digital implementation of the FlipToons board game by Thunderworks Games. Not affiliated with or endorsed by Thunderworks Games — see [LICENSE](./LICENSE).

Playable end-to-end: solo (local, in-browser) and real 2-4 player multiplayer with room codes, seats, turn order, and a Final Flip. Live at [fliptoons.win](https://fliptoons.win).

## The physical game

This is a digital adaptation of a real board game — buy it and read the rules for yourself:
...
Requires [bun](https://bun.sh) (runtime, package manager, test runner) and [wrangler](https://developers.cloudflare.com/workers/wrangler/) (Cloudflare's CLI, for the multiplayer server).
